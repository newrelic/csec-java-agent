package com.nr.agent.security.instrumentation.jdbc.mariadb300;
...
public class DataSourceTest {
    ...
    public static void setUpDb() throws Exception {
        ...
        String dbName = "MariaDB" + System.currentTimeMillis();
        mariaDb = DB.newEmbeddedDB(builder.build());
        connectionString = StringUtils.replace(builder.getURL(dbName), "mysql", "mariadb");
        mariaDb.start();
