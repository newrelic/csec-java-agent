...
package com.newrelic.agent.security.instrumentation.dynamodb_212;
...
public abstract class DynamoDBUtil {
    ...
    private static <InputT> DynamoDBOperation checkAndGenerateOperation(InputT value, List<DynamoDBRequest> requests, String klassName) {
        ...
        try {
            ...
            NewRelicSecurity.getAgent().log(LogLevel.WARNING, String.format(message, "DYNAMODB-2.1.2", e.getMessage()), e, DynamoDBUtil.class.getName());
        }
        return operation;
    }
}
