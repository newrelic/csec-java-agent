package com.nr.agent.security.instrumentation.unboundid.ldap;
...
@InstrumentationTestConfig(includePrefixes = { "com.unboundid.ldap.sdk", "com.newrelic.agent.security.instrumentation.unboundid.ldap.LDAPUtils" })
