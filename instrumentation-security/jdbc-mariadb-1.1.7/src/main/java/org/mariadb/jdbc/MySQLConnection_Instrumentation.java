...
@Weave(type = MatchType.ExactClass, originalName = "org.mariadb.jdbc.MySQLConnection")
public class MySQLConnection_Instrumentation {
    @WeaveAllConstructors
    private MySQLConnection_Instrumentation() {
