...
@Weave(type = MatchType.ExactClass, originalName = "com.datastax.oss.driver.internal.core.metadata.SniEndPoint")
public class SniEndPoint_Instrumentation {

    public SniEndPoint_Instrumentation(InetSocketAddress address, String serverName) {
