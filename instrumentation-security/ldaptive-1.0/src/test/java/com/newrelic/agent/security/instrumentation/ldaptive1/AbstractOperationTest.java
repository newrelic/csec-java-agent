package com.newrelic.agent.security.instrumentation.ldaptive1;
...
@InstrumentationTestConfig(includePrefixes = { "org.ldaptive", "com.newrelic.agent.security.instrumentation.ldaptive1.LDAPUtils" })
