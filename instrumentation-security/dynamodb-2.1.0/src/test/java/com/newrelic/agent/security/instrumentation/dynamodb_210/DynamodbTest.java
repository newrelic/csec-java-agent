package com.newrelic.agent.security.instrumentation.dynamodb_210;
...
@InstrumentationTestConfig(includePrefixes = {"com.newrelic.agent.security.instrumentation.dynamodb_210", "software.amazon.awssdk.core"})
