...
package com.nr.agent.security.instrumentation.vertx.core330;
...
public class VertxClientTest {
    ...
    public void testEnd() throws InterruptedException {
        ...
        httpClient.request(HttpMethod.GET, port, "localhost", "/hi").handler(reqHandler(latch)).end();
        latch.await();
    ...
    @Test
    public void testEndMethodCSECHeader3() throws InterruptedException {
        SecurityIntrospector introspector = SecurityInstrumentationTestRunner.getIntrospector();
        setCsecHeaders(introspector);
