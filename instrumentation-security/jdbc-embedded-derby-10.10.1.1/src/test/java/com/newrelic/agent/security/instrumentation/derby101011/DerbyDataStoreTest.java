package com.newrelic.agent.security.instrumentation.derby101011;
...
public class DerbyDataStoreTest {
    ...
    private void getConnection(EmbeddedBaseDataSource baseDataSource) throws SQLException {
    ...
    private void getConnection1(EmbeddedBaseDataSource baseDataSource) throws SQLException {
        baseDataSource.setCreateDatabase("create");
        baseDataSource.setDatabaseName(DB_NAME);
