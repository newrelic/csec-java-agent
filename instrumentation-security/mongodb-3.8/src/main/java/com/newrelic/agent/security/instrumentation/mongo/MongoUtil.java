...
public class MongoUtil {
    ...
    public static AbstractOperation recordMongoOperation(List<BsonDocument> command, String typeOfOperation, String klassName, String methodName) {
        ...
        try {
            ...
            if (e instanceof NewRelicSecurityException) {
                NewRelicSecurity.getAgent().log(LogLevel.WARNING, String.format(GenericHelper.SECURITY_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e, MongoUtil.class.getName());
                throw e;
            }
            NewRelicSecurity.getAgent().log(LogLevel.SEVERE, String.format(GenericHelper.REGISTER_OPERATION_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e, MongoUtil.class.getName());
            NewRelicSecurity.getAgent().reportIncident(LogLevel.SEVERE, String.format(GenericHelper.REGISTER_OPERATION_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e, MongoUtil.class.getName());
        }
        return operation;
    }
    ...
    public static void registerExitOperation(boolean isProcessingAllowed, AbstractOperation operation) {
        try {
            ...
            NewRelicSecurity.getAgent().log(LogLevel.FINEST, String.format(GenericHelper.EXIT_OPERATION_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e, MongoUtil.class.getName());
        }
    }
    ...
    public static <T> AbstractOperation getAbstractOperation(WriteOperation<T> operation, String className) {
        try {
            ...
            if (operation instanceof AggregateToCollectionOperation) {
                ...
                return recordMongoOperation(aggregateToCollectionOperation.getPipeline(), MongoUtil.OP_WRITE, className, MongoUtil.METHOD_EXECUTE);
                ...
                return recordMongoOperation(operations, MongoUtil.OP_DELETE, className, MongoUtil.METHOD_EXECUTE);
                ...
                return recordMongoOperation(operations, MongoUtil.OP_FIND_AND_DELETE, className, MongoUtil.METHOD_EXECUTE);
                ...
                if (findAndUpdateOperation.getArrayFilters() != null) {
                    operations.addAll(findAndUpdateOperation.getArrayFilters());
                }
                ...
                return recordMongoOperation(operations, MongoUtil.OP_INSERT, className, MongoUtil.METHOD_EXECUTE);
                ...
                return recordMongoOperation(operations, MongoUtil.OP_MAP_REDUCE, className, MongoUtil.METHOD_EXECUTE);
                ...
                for (UpdateRequest updateRequest : updateOperation.getUpdateRequests()) {
                    ...
                    if (updateRequest.getArrayFilters() != null) {
                        operations.addAll(updateRequest.getArrayFilters());
                    }
                }
                return recordMongoOperation(operations, MongoUtil.OP_UPDATE, className, MongoUtil.METHOD_EXECUTE);
                ...
                return recordWriteRequest(mixedBulkWriteOperation.getWriteRequests(), className, MongoUtil.METHOD_EXECUTE);
            }
        } catch (Throwable e) {
            if (e instanceof NewRelicSecurityException) {
                NewRelicSecurity.getAgent().log(LogLevel.WARNING, String.format(GenericHelper.SECURITY_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e, MongoUtil.class.getName());
        ...
        try {
            ...
            if (e instanceof NewRelicSecurityException) {
                NewRelicSecurity.getAgent()
                        .log(LogLevel.WARNING, String.format(GenericHelper.SECURITY_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e,
                                MongoUtil.class.getName());
                throw e;
            }
            NewRelicSecurity.getAgent()
                    .log(LogLevel.SEVERE, String.format(GenericHelper.REGISTER_OPERATION_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e,
                            MongoUtil.class.getName());
            NewRelicSecurity.getAgent()
                    .reportIncident(LogLevel.SEVERE, String.format(GenericHelper.REGISTER_OPERATION_EXCEPTION_MESSAGE, MONGODB_3_8, e.getMessage()), e,
                            MongoUtil.class.getName());
        }
