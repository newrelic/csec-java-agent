...
public class JerseyTests {
    ...
    private String[] fireRequest(final String path) {
        ...
        try ( Response response = target.request().header(Header.ContentType.toString(), MediaType.APPLICATION_JSON).get();
    ...
    private String[] fireRequest1(final String path) {
        ...
        try ( Response response = target.request().header(Header.ContentType.toString(), MediaType.APPLICATION_JSON)
