package com.nr.agent.instrumentation.jedis_4_0_0;
...
public class JedisTest {
    ...
    public void testLpush_Llen_Linsert_Lindex_Lpop_Lrem() {
        ...
        jedis.linsert(keyValuePair.getKey(), ListPosition.AFTER, "0", keyValuePair.getValue());
    ...
    private static void verifier(Protocol.Command cmd, RedisOperation operation, List<String> keyValuePair) {
        ...
        Assert.assertEquals(String.format("[%s] Invalid executed class name.", cmd), Connection.class.getName(), operation.getClassName());
