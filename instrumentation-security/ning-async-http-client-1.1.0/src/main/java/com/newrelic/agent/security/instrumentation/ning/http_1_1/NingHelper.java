...
public class NingHelper {
    ...
    public static final String NING_ASYNC_HTTP_CLIENT_1_1_0 = "NING-ASYNC-HTTP-CLIENT-1.1.0";
    ...
    public static void registerExitOperation(boolean isProcessingAllowed, AbstractOperation operation) {
        try {
            ...
            NewRelicSecurity.getAgent().log(LogLevel.FINEST, String.format(GenericHelper.EXIT_OPERATION_EXCEPTION_MESSAGE, NING_ASYNC_HTTP_CLIENT_1_1_0, e.getMessage()), e, NingHelper.class.getName());
        }
    }
    ...
    public static AbstractOperation preprocessSecurityHook(Request request, String uri, String methodName, String className) {
        try {
            ...
            if (e instanceof NewRelicSecurityException) {
                NewRelicSecurity.getAgent().log(LogLevel.WARNING, String.format(GenericHelper.SECURITY_EXCEPTION_MESSAGE, NING_ASYNC_HTTP_CLIENT_1_1_0, e.getMessage()), e, NingHelper.class.getName());
                throw e;
            }
            NewRelicSecurity.getAgent().log(LogLevel.SEVERE, String.format(GenericHelper.REGISTER_OPERATION_EXCEPTION_MESSAGE, NING_ASYNC_HTTP_CLIENT_1_1_0, e.getMessage()), e, NingHelper.class.getName());
            NewRelicSecurity.getAgent().reportIncident(LogLevel.SEVERE, String.format(GenericHelper.REGISTER_OPERATION_EXCEPTION_MESSAGE, NING_ASYNC_HTTP_CLIENT_1_1_0, e.getMessage()), e, NingHelper.class.getName());
        }
        return null;
    }
