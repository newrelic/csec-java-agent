...
public class AsyncHttpProvider_Instrumentation {
    ...
    public <T> Future<T> execute(Request request, AsyncHandler<T> handler) throws IOException {
        ...
        try {
            ...
            NewRelicSecurity.getAgent().log(LogLevel.WARNING, String.format(GenericHelper.URI_EXCEPTION_MESSAGE, NingHelper.NING_ASYNC_HTTP_CLIENT_1_1_0, e.getMessage()), e, AsyncHttpProvider_Instrumentation.class.getName());
        }
