...
public class GrpcHelper {
    public static final String NR_SEC_GRPC_REQUEST_DATA = "NR_SEC_GRPC_REQUEST_DATA";
    public static final String NR_SEC_GRPC_RESPONSE_DATA = "NR_SEC_GRPC_RESPONSE_DATA";
