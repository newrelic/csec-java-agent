...
import static com.newrelic.agent.security.instrumentator.httpclient.IRestClientConstants.COLLECTOR_UPLOAD_LOG;
...
//                    logger.log(LogLevel.WARNING, String.format(UNKNOWN_ASYNC_API_S, api), HttpClient.class.getName());
    ...
    public <T> T readResponse(InputStream stream, Class<T> valueType) {
        try {
