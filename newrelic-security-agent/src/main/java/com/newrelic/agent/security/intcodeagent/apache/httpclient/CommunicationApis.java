...
public class CommunicationApis {
    ...
    public static final String POST_CRITICAL_MESSAGE = "postCriticalMessage";
    ...
    public static final Map<String, RequestLayout> REQUEST_CONFIG = Collections.unmodifiableMap(
            new HashMap<String, RequestLayout>() {{
                ...
                put(POST_CRITICAL_MESSAGE, new RequestLayout(POST_CRITICAL_MESSAGE, "POST", "/v1/critical-message", "application/json", "gzip"));
