...
public abstract class MapConstants {
    ...
    static {
        ...
        FILE_EXECUTORS.put(IAgentConstants.JAVA_IO_FILE_INPUTSTREAM_OPEN, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_IO_FILE_OUTPUTSTREAM_OPEN, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_OPEN, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_FOPEN, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_LINK, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_UNLINK, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_MKNOD, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_RENAME, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_MKDIR, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_RMDIR, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_SYMLINK, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_CHOWN, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_NIO_UNIX_CHMOD, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_IO_UNIX_FS_DELETE, VulnerabilityCaseType.FILE_OPERATION);
        FILE_EXECUTORS.put(IAgentConstants.JAVA_IO_RANDOM_ACCESS_FILE_OPEN, VulnerabilityCaseType.FILE_OPERATION);
...
//		INSTRUMENTED_METHODS.put(IO_UNDERTOW_SERVLET_HANDLERS_SERVLET_HANDLER, Collections.singletonList("handleRequest"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_HTTP_REQUEST_EXECUTOR, Collections.singletonList("doSendRequest"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_JAVA_HTTP_HANDLER, Collections.singletonList("openConnection"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_JAVA_HTTPS_HANDLER, Collections.singletonList("openConnection"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_JAVA_SSL_HTTPS_HANDLER, Collections.singletonList("openConnection"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_JDK_INCUBATOR_HTTP_MULTIEXCHANGE, Arrays.asList(new String[]{"response", "responseAsync", "multiResponseAsync"}));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_WEBLOGIC_SERVLET_INTERNAL_WEB_APP_SERVLET_CONTEXT, Collections.singletonList("execute"));  // Handle differently
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_APACHE_COMMONS_HTTP_METHOD_DIRECTOR, Collections.singletonList("executeWithRetry"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_OKHTTP_HTTP_ENGINE, Collections.singletonList("sendRequest"));
        INSTRUMENTED_METHODS.put(IAgentConstants.CLASS_WEBLOGIC_HTTP_HANDLER, Collections.singletonList("openConnection"));
...
//		INSTRUMENTED_METHODS.put(JAVA_IO_RANDOM_ACCESS_FILE, Collections.singletonList("open"));
        ...
        // System Command
        EXECUTORS.put(IAgentConstants.SYSYTEM_CALL_START, VulnerabilityCaseType.SYSTEM_COMMAND);

        // MSSQL
        EXECUTORS.put(IAgentConstants.EXEC_MSSQL_SQLTIMEOUT, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MSSQL, VulnerabilityCaseType.SQL_DB_COMMAND);

        // MYSQL
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_505, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_51X, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_6X, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_6X2, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_6X3, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_6X4, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.EXEC_MYSQL_8X, VulnerabilityCaseType.SQL_DB_COMMAND);

        // ORACLE
        EXECUTORS.put(IAgentConstants.EXEC_ORACLE, VulnerabilityCaseType.SQL_DB_COMMAND);

        // postgresql
        EXECUTORS.put(IAgentConstants.PSQLV3_EXECUTOR, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.PSQLV2_EXECUTOR, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.PSQL42_EXECUTOR, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.PSQLV3_EXECUTOR7_4, VulnerabilityCaseType.SQL_DB_COMMAND);

        // HSQLDB
        EXECUTORS.put(IAgentConstants.HSQL_V2_4, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.HSQL_V1_8_CONNECTION, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.HSQL_V1_8_SESSION, VulnerabilityCaseType.SQL_DB_COMMAND);
        EXECUTORS.put(IAgentConstants.HSQL_V2_3_4_CLIENT_CONNECTION, VulnerabilityCaseType.SQL_DB_COMMAND);

        // MongoDB
        EXECUTORS.putAll(MONGO_EXECUTORS);

        // dynamic class loading
        EXECUTORS.put(IAgentConstants.URL_CLASS_LOADER, VulnerabilityCaseType.DYNAMIC_CLASS_LOADING);
        EXECUTORS.put(IAgentConstants.EXEC_DEFINE_CLASS, VulnerabilityCaseType.DYNAMIC_CLASS_LOADING);
        EXECUTORS.put(IAgentConstants.EXEC_URL_CLASS_LOADER_NEW_INSTANCE, VulnerabilityCaseType.DYNAMIC_CLASS_LOADING);

        // http request
        EXECUTORS.put(IAgentConstants.APACHE_HTTP_REQUEST_EXECUTOR_METHOD, VulnerabilityCaseType.HTTP_REQUEST);

        //JAVA_OPEN_CONNECTION_METHOD,
        EXECUTORS.put(IAgentConstants.JAVA_OPEN_CONNECTION_METHOD2, VulnerabilityCaseType.HTTP_REQUEST);
        EXECUTORS.put(IAgentConstants.JAVA_OPEN_CONNECTION_METHOD2_HTTPS, VulnerabilityCaseType.HTTP_REQUEST);
        EXECUTORS.put(IAgentConstants.JAVA_OPEN_CONNECTION_METHOD2_HTTPS_2, VulnerabilityCaseType.HTTP_REQUEST);
        EXECUTORS.put(IAgentConstants.JDK_INCUBATOR_MULTIEXCHANGE_RESONSE_METHOD, VulnerabilityCaseType.HTTP_REQUEST);
        EXECUTORS.put(IAgentConstants.JDK_INCUBATOR_MULTIEXCHANGE_RESONSE_ASYNC_METHOD, VulnerabilityCaseType.HTTP_REQUEST);

        EXECUTORS.putAll(FILE_EXECUTORS);

        EXECUTORS.put(IAgentConstants.APACHE_COMMONS_HTTP_METHOD_DIRECTOR_METHOD, VulnerabilityCaseType.HTTP_REQUEST);
        EXECUTORS.put(IAgentConstants.OKHTTP_HTTP_ENGINE_METHOD, VulnerabilityCaseType.HTTP_REQUEST);
        EXECUTORS.put(IAgentConstants.WEBLOGIC_OPEN_CONNECTION_METHOD, VulnerabilityCaseType.HTTP_REQUEST);

        // Mysql Connector/J 5.0.5
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_5_0_SOURCE);
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_5_0_4_PREPARED_SOURCE);
        // Mysql Connector/J 5.1.x
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_5_1_SOURCE);
        // Mysql Connector/J 6.x
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_6_0_2_SOURCE);
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_6_0_3_SOURCE);
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_6_SOURCE);
        // Mysql Connector/J 8.x
        MYSQL_SOURCE_METHOD_LIST.add(IAgentConstants.MYSQL_CONNECTOR_8_SOURCE);
