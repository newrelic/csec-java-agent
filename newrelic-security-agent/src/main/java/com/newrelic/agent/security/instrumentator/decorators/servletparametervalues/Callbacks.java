package com.newrelic.agent.security.instrumentator.decorators.servletparametervalues;
...
//        }
    ...
    public static void doOnExit(String sourceString, String className, String methodName, Object obj, Object[] args,
        ...
        if (!ThreadLocalHttpMap.getInstance().isEmpty()
            ...
            try {
                ThreadLocalOperationLock.getInstance().acquire();
                ThreadLocalExecutionMap.getInstance().getHttpRequestBean().getParameterMap().putIfAbsent(args[0].toString(), (String[]) returnVal);
            } finally {
                ThreadLocalOperationLock.getInstance().release();
            }
        }
