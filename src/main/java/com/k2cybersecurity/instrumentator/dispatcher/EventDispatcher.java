...
public class EventDispatcher {
	...
	public static void dispatch(Object objectBean){
...
//		printDispatch(objectBean);
		DispatcherPool.getInstance().dispatchEvent(new HttpRequestBean(ThreadLocalExecutionMap.getInstance().getHttpRequestBean()) , new AgentMetaData(ThreadLocalExecutionMap.getInstance().getMetaData()), Thread.currentThread().getStackTrace(), objectBean);
	}
