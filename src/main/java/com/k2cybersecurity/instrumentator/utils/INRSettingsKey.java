...
public class INRSettingsKey {
    public static final String SECURITY_POLICY_VULNERABILITY_SCAN_ENABLE = "security.policy.vulnerabilityScan.enable";
    public static final String SECURITY_POLICY_VULNERABILITY_SCAN_IAST_SCAN_ENABLE = "security.policy.vulnerabilityScan.iastScan.enable";
    ...
    public static final String SECURITY_POLICY_PROTECTION_MODE_ENABLE = "security.policy.protectionMode.enable";
    public static final String SECURITY_POLICY_PROTECTION_MODE_IP_BLOCKING_ENABLE = "security.policy.protectionMode.ipBlocking.enable";
    ...
    public static final String SECURITY_POLICY_PROTECTION_MODE_API_BLOCKING_ENABLE = "security.policy.protectionMode.apiBlocking.enable";
