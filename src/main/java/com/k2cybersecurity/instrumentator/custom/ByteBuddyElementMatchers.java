...
public class ByteBuddyElementMatchers {
	 ...
	 */
	@HashCodeAndEqualsPlugin.Enhance public static class SafeHasSuperTypeMatcher<T extends TypeDescription>
		...
		@Override public boolean matches(final T target) {
	 ...
	 */
	@HashCodeAndEqualsPlugin.Enhance public static class SafeErasureMatcher<T extends TypeDefinition>
			extends ElementMatcher.Junction.AbstractBase<T> {
	 ...
	 */
	@HashCodeAndEqualsPlugin.Enhance public static class SafeMatcher<T>
			extends ElementMatcher.Junction.AbstractBase<T> {
	...
	// TODO: add javadoc
	@HashCodeAndEqualsPlugin.Enhance public static class HasSuperMethodMatcher<T extends MethodDescription>
			extends ElementMatcher.Junction.AbstractBase<T> {
		...
		@Override public boolean matches(final MethodDescription target) {
