...
public class ThreadLocalJSPServiceLock {
    ...
    private static ThreadLocal<ThreadLocalJSPServiceLock> instance = new ThreadLocal<ThreadLocalJSPServiceLock>() {
        @Override
        protected ThreadLocalJSPServiceLock initialValue() {
            return new ThreadLocalJSPServiceLock();
        }
    };

    private ThreadLocalJSPServiceLock() {
        lock = new Semaphore(1);
    }

    public static ThreadLocalJSPServiceLock getInstance() {
        return instance.get();
    }
