...
public class StaticMethodExit {
    ...
    public static void exit(@Advice.Origin String signature, @Advice.Return Object value, @Advice.Thrown Throwable error, @Advice.AllArguments Object[] args) throws Throwable {
