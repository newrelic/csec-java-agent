...
public class MethodExit {
    ...
    public static void exit(@Advice.Origin String signature, @Advice.Return Object value, @Advice.Thrown Throwable error, @Advice.This Object thisArg, @Advice.AllArguments Object[] args) throws Throwable {
