...
public class Callbacks {
    ...
    public static void doOnEnter(String sourceString, String className, String methodName, Object obj, Object[] args, String exectionId) {
        ...
        EventDispatcher.dispatch(new NoSQLOperationalBean(args, className, sourceString, exectionId, Instant.now().toEpochMilli()), VulnerabilityCaseType.NOSQL_DB_COMMAND);
    }
