...
//							System.out.println("The pattern string for xpath is : " + patternString);
						XPathOperationalBean xpathOperationalBean = new XPathOperationalBean(patternString, className,
...
//						ex.printStackTrace();
					...
					"public void org.jaxen.saxpath.base.XPathReader.parse(java.lang.String) throws org.jaxen.saxpath.SAXPathException")) {
				...
				if (xpathExpressionObject != null) {
					...
					if (StringUtils.isNotBlank(xpathExpression)) {
						...
						XPathOperationalBean xPathOperationalBean = new XPathOperationalBean(xpathExpression, className,
